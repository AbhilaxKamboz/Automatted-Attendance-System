...
def function1():
    ...
    # os.system(r"C:\Users\hp\Desktop/20232028 Abhilax Synopsis.pdf")
...
Button(root,text="Exit",font=('times new roman',40),bg="red",fg="white",command=root.destroy).grid(row=8,columnspan=2,sticky=N+E+W+S,padx=5,pady=5)
